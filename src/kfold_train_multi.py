...
if __name__ == '__main__':
    ...
    # data paths
    train_features_path = root.parent.joinpath('dataset', 'train_multi_inputs.h5')
    train_targets_path = root.parent.joinpath('dataset', 'train_multi_targets.h5')
    test_features_path = root.parent.joinpath('dataset', 'test_multi_inputs.h5')
